parameters = [
  ...
  { name = "prod.user.redis_host", value = "elasticache-prod-elasticache-001.vxg4pu.0001.use1.cache.amazonaws.com" },
  { name = "prod.user.mongo_endpoint", value = "mongodb-prod.panda4u.online" },
  { name = "prod.cart.redis_host", value = "elasticache-prod-elasticache-001.vxg4pu.0001.use1.cache.amazonaws.com" },
  ...
  { name = "prod.rds.db_host", value = "rds-dev-rds.cluster-cuhmpceeivyr.us-east-1.rds.amazonaws.com" },
...
passwords = [
  ...
  { name = "prod.catalogue.mongo_url", value = "mongodb://roboshop:roboshop12345@docdb-dev.cluster-cuhmpceeivyr.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" },
  { name = "prod.user.mongo_url", value = "mongodb://roboshop:roboshop12345@docdb-dev.cluster-cuhmpceeivyr.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
